...
var runner = function runner(_ref, cb) {
  ...
  var command = 'casperjs test ' + files + ' --verbose --pre=' + __dirname + '/pre.js --includes=' + __dirname + '/includes.js --post=' + __dirname + '/post.js';
  _child_process.exec(command, function (err, stdout) {
